...
import { Menu, MessageSquare, ShoppingCart, X } from "lucide-react";
          ...
          <div className="flex items-center gap-3 border-l border-gray-200 pl-4">
            {user ? (
              <>
                <Link
                  to="/cart"
                  className="relative text-gray-600 hover:text-primary transition-colors p-2 rounded-lg hover:bg-gray-50"
                >
                ...
                <div className="text-gray-600 hover:text-primary transition-colors p-2 rounded-lg hover:bg-gray-50">
                  <Notifications />
                </div>
                <Link
