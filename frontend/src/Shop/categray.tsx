      ...
      >
        <div className="w-full sm:w-1/2 md:w-1/4 p-2 relative ">
          <img
            ...
            alt=""
            className="w-full rounded-2xl shadow shadow-black  shadow-5xl"
          />
          <p className="absolute bottom-1/7 md:bottom-1/8 left-1/2 -translate-x-1/2 -translate-y-1/2 text-2xl text-white text-center">
            {" "}
            shop for loved{" "}
          </p>
        </div>
